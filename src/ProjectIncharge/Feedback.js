...
function ICProjects(props) {
    ...
    const submitFeedback =(e) =>{
        e.preventDefault();
        Axios.post('https://localhost:7273/api/Feedback/PICFeedback', {
            feedbackByPIC : feedback,
            projectId: props.match.params.id
                    ...
                    <div className='col-md-8 col-md-offset-2 formData'>
                        <form>
                            <div className='form-group'><label className='form-label'>Feedback</label>
                                ...
                                <button className='col-md-4 col-md-offset-4 btn btn-primary' onClick={submitFeedback}>Submit</button>
                        </form>
                    </div>
            </>
        );
